...
//return 0;
 ...
 //               dEdb.add(std::make_tuple(impact_parameter, E));
    ...
    std::string namesss{"g_report_"+name_postfix+".dat"};
    std::string namesss_midrap{"g_report_midrap_"+name_postfix+".dat"};
                                              
    glauber_report_file.open(namesss, std::ios::out);
