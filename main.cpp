...
int main()
{
    ...
    //sigma_jet stuff
    const pqcd::sigma_jet_params params = pqcd::sigma_jet_params(
        pqcd::scaled_from_kt, //scale_choice
        1.0, //scalar
        false, //projectile_with_npdfs
        false, //target_with_npdfs
        false, //isoscalar_projectile
        false, //isoscalar_target
        1, //npdf_setnumber
        false); //use_ses
    ...
    std::variant<linear_interpolator, xsectval> sigma_jets = pqcd::calculate_sigma_jet(p_pdf, &mand_s, &kt02, &params);
