...
_SRCS_CPP = ars.cpp hcubature.cpp histogram.cpp linear_interpolator.cpp nn_coll.cpp nucleon.cpp nucleus_generator.cpp pqcd.cpp
SRCS_CPP = $(patsubst %,$(SDIR)/%,$(_SRCS_CPP))

_SRCS_H = ars.hpp converged.h cubature.h histogram.hpp linear_interpolator.hpp linterp.h nn_coll.hpp nucleon.hpp nucleus_generator.hpp pqcd.hpp typedefs.hpp vwrapper.h
