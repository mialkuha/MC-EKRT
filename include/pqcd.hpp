...
public:
    ...
    public:
        ...
        ///\param p_u_hat = pointer to subprocess mandelstam variable u
        ///
        static xsectval sigma_jet(const rapidity * p_x1, const rapidity * p_x2,  const momentum * p_q2, std::shared_ptr<LHAPDF::GridPDF> p_pdf,  const momentum * p_s_hat, const momentum * p_t_hat, const momentum * p_u_hat, const params * p_params) noexcept;
    };
    enum scale_choice
    {
        scaled_from_kt,
    ...
    static int sigma_jet_integrand(unsigned ndim, const double *p_x, void *p_fdata, unsigned fdim, double *p_fval) noexcept;static void scale_limits_from_0_1(const rapidity & z1, const rapidity & z2, const rapidity & z3,                      //variables between 0 and 1
