...
public:
    class piecewise_exponential_distribution
    {
        ...
        private:
            ...
            {
                std::cout<<"normalization: "<<this->normalization<<std::endl<<"exp_factors: ";
                for (auto a: this->exp_factors)
                {
                    std::cout<<a<<' ';
                }
                std::cout<<std::endl<<"cdf_weights: ";
                for (auto a: this->cdf_weights)
                {
                    std::cout<<a<<' ';
                }
                std::cout<<std::endl<<"abscissae: ";
...
private:
    ...
    void report() noexcept
    {
        ...
        std::cout<<std::endl<<"log_der_values: ";
        ...
        std::cout<<std::endl<<"zk: ";
        for (auto a: this->zk)
        {
            std::cout<<a<<' ';
        }
        std::cout<<std::endl<<"uk: ";
        for (auto a: this->uk)
        {
            std::cout<<a<<' ';
        }
