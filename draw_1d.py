...
for name in obs_names:
	infile_name1  = name + '_sim_testpp_mb.dat'
	infile_name2  = name + '_sim_testpp_mb_MC.dat'
	infile_name3  = name + '_sim_testAA_mb.dat'
	infile_name4  = name + '_sim_testAA_mb_MC.dat'
	...
	ax.plot(y_points, np.transpose(data3), 'r-', label=r'$nPDF$', linewidth=1)
	ax.plot(y_points, np.transpose(data4), 'r--', label=r'$nPDF\;MC$', linewidth=1)
	ax.minorticks_on()
