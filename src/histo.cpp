...
auto histo_2d::get_histo() const noexcept -> std::tuple<std::vector<std::vector<double>>,
...
auto histo_3d::get_histo() const noexcept -> std::tuple<std::vector<std::vector<std::vector<double>>>,
...
auto histo_2d::project_1d(const bool project_ys) const noexcept -> std::tuple<std::vector<double> &&,
                                                                              double,
                                                                              double,
                                                                              std::vector<double> &&,
                                                                              uint_fast64_t>
...
auto histo_3d::project_1d(const uint_fast8_t dim_left) const noexcept -> std::tuple<std::vector<double> &&,
                                                                                    double,
                                                                                    double,
                                                                                    std::vector<double> &&,
                                                                                    uint_fast64_t>
...
auto histo_3d::project_2d(const uint_fast8_t dim_integrated)
    const noexcept -> std::tuple<std::vector<std::vector<double>>,
                                 double,
                                 double,
                                 std::tuple<std::vector<double>, std::vector<double>>,
                                 uint_fast64_t>
...
auto operator==(
    const histo_1d &c1,
    const histo_1d &c2) noexcept -> bool
{
...
auto operator==(
    const histo_2d &c1,
    const histo_2d &c2) noexcept -> bool
{
    bool ret = (c1.xs.size() == c2.xs.size());
...
auto operator==(
    const histo_3d &c1,
    const histo_3d &c2) noexcept -> bool
{
    bool ret = (c1.xs.size() == c2.xs.size());
    ret *= (c1.ys.size() == c2.ys.size());
