...
public:
     ...
     */
    histo_1d(
        const std::vector<double> &xs_) noexcept : xs(xs_),
    ...
    histo_1d(
        ...
        const std::vector<double> &ys_) noexcept : xs(xs_),
                                                   counts(xs_.size() - 1, 0.0),
                                                   total_counts(0),
                                                   underf(0),
                                                   overf(0)
     ...
     */
    auto add(
        const std::tuple<double, double> &y_) noexcept -> void;
     ...
     */
    auto add(
        const std::vector<double> &news) noexcept -> void;
     ...
     */
    auto add(
        const std::vector<std::tuple<double, double>> &news) noexcept -> void;
     ...
     */
    auto add(
        const histo_1d &other) noexcept -> void;
     ...
     */
    auto get_histo() const noexcept -> std::tuple<std::vector<double>,
                                                  double,
                                                  double,
                                                  std::vector<double>,
                                                  uint_fast64_t>;
...
public:
     ...
     */
    auto add(
        const std::tuple<double, double> &x) noexcept -> void;
     ...
     */
    auto add(
        std::vector<std::tuple<double, double>> news) noexcept -> void;
     ...
     */
    auto add(
        const histo_2d &other) noexcept -> void;
     ...
     *     uint_fast64_t >                           = Total # of points
     */
    auto get_histo() const noexcept -> std::tuple<std::vector<std::vector<double>>,
     ...
     *          uint_fast64_t>              = Total # of points
     */
    auto project_1d(const bool project_ys) const noexcept -> std::tuple<std::vector<double> &&,
                                                                        double,
                                                                        double,
                                                                        std::vector<double> &&,
                                                                        uint_fast64_t>;
...
public:
    ...
    histo_3d(
        ...
        const std::vector<double> &zs_) noexcept : xs(xs_),
                                                   ys(ys_),
                                                   zs(zs_),
                                                   counts(
                                                       xs_.size() - 1,
     ...
     */
    auto add(
        const std::tuple<double, double, double> &x) noexcept -> void;
     ...
     */
    auto add(
        std::vector<std::tuple<double, double, double>> news) noexcept -> void;
     ...
     */
    auto add(
        const histo_3d &other) noexcept -> void;
     ...
     *     uint_fast64_t >                                       = Total # of points
     */
    auto get_histo() const noexcept -> std::tuple<std::vector<std::vector<std::vector<double>>>,
     ...
     *          uint_fast64_t>              = Total # of points
     */
    auto project_1d(const uint_fast8_t dim_left) const noexcept -> std::tuple<std::vector<double> &&,
                                                                              double,
                                                                              double,
                                                                              std::vector<double> &&,
                                                                              uint_fast64_t>;
