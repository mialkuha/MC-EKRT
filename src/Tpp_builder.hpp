...
public:
    ...
    //                 for (auto itt = nucl_indexes.begin(); itt < nucl_indexes.end(); itt++)
    //                 {
    //                     auto aveTA = this->calculate_sum_tpp(nucl[*itt], nucl);
    //                     for (uint_fast8_t i=0; i<25; i++)
    //                     {
    //                         sum_tpps[i][*itt] = std::exp(c_vector[i]*aveTA);
    //                         // if (c_vector[i] < 0 && aveTA > -1.0/(2.0*c_vector[i]))
    //                         // {
    //                         //     sum_tpps[i][*itt] = -1.0/(4.0*c_vector[i]);
    //                         // }
    //                         // else
    //                         // {
    //                         //     sum_tpps[i][*itt] = aveTA*(1+c_vector[i]*aveTA);
    //                         // }
    //                     }
    //                 }
